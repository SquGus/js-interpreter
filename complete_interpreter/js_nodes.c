...
ast_node *node_new(enum ast_node_type type, ast_node *e1, ast_node *e2, ast_node *e3,
...
ast_node *node_pop(ast_node *node) {
...
bool node_empty(ast_node *node) {
  return node->visited;
}

void node_rewind(ast_node *node) {
...
void node_print(ast_node *node, bool rec, int depth) {
